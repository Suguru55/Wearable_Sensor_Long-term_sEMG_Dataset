function [tbl, c_tr] = plot_figure4_and_figure5(config)
...
for sub_ind = 1:config.sub_num
    ...
    er_N_t1 = []; er_N_t2 = []; er_N_t3 = []; er_N_t4 = [];
    er_I_t1 = []; er_I_t2 = []; er_I_t3 = []; er_I_t4 = [];
    er_O_t1 = []; er_O_t2 = []; er_O_t3 = []; er_O_t4 = [];
    ...
    for day_ind = 1:config.day_num + 4
        ...
        if day_ind <= config.day_num
            if config.pos_label(day_ind) == 1
                bar(x(1+(day_ind-1)*3),mean(er_temp_t1(:),1),'FaceColor',[1,0,0],'FaceAlpha',0.8,'EdgeColor','none');
                if day_ind == 1
                    hold on
                end
                bar(x(2+(day_ind-1)*3),mean(er_temp_t2(:),1),'FaceColor',[1,0,0],'FaceAlpha',0.6,'EdgeColor','none');
                bar(x(3+(day_ind-1)*3),mean(er_temp_t3(:),1),'FaceColor',[1,0,0],'FaceAlpha',0.4,'EdgeColor','none');
                errorbar(x(1+(day_ind-1)*3),mean(er_temp_t1(:),1),std(er_temp_t1(:),1)/sqrt(length(er_temp_t1(:))),'k','LineWidth',1); 
                errorbar(x(2+(day_ind-1)*3),mean(er_temp_t2(:),1),std(er_temp_t2(:),1)/sqrt(length(er_temp_t2(:))),'k','LineWidth',1);
                errorbar(x(3+(day_ind-1)*3),mean(er_temp_t3(:),1),std(er_temp_t3(:),1)/sqrt(length(er_temp_t3(:))),'k','LineWidth',1);
            else
                if config.pos_label(day_ind) == 2
                    bar(x(1+(day_ind-1)*3),mean(er_temp_t1(:),1),'FaceColor',[0,1,1],'FaceAlpha',0.8,'EdgeColor','none');
                    bar(x(2+(day_ind-1)*3),mean(er_temp_t2(:),1),'FaceColor',[0,1,1],'FaceAlpha',0.6,'EdgeColor','none');
                    bar(x(3+(day_ind-1)*3),mean(er_temp_t3(:),1),'FaceColor',[0,1,1],'FaceAlpha',0.4,'EdgeColor','none');
                    errorbar(x(1+(day_ind-1)*3),mean(er_temp_t1(:),1),std(er_temp_t1(:),1)/sqrt(length(er_temp_t1(:))),'k','LineWidth',1);
                    errorbar(x(2+(day_ind-1)*3),mean(er_temp_t2(:),1),std(er_temp_t2(:),1)/sqrt(length(er_temp_t2(:))),'k','LineWidth',1);
                    errorbar(x(3+(day_ind-1)*3),mean(er_temp_t3(:),1),std(er_temp_t3(:),1)/sqrt(length(er_temp_t3(:))),'k','LineWidth',1);
                else
                    bar(x(1+(day_ind-1)*3),mean(er_temp_t1(:),1),'FaceColor',[0,0,1],'FaceAlpha',0.8,'EdgeColor','none');
                    bar(x(2+(day_ind-1)*3),mean(er_temp_t2(:),1),'FaceColor',[0,0,1],'FaceAlpha',0.6,'EdgeColor','none')
                    bar(x(3+(day_ind-1)*3),mean(er_temp_t3(:),1),'FaceColor',[0,0,1],'FaceAlpha',0.4,'EdgeColor','none');
                    errorbar(x(1+(day_ind-1)*3),mean(er_temp_t1(:),1),std(er_temp_t1(:),1)/sqrt(length(er_temp_t1(:))),'k','LineWidth',1);
                    errorbar(x(2+(day_ind-1)*3),mean(er_temp_t2(:),1),std(er_temp_t2(:),1)/sqrt(length(er_temp_t2(:))),'k','LineWidth',1);
                    errorbar(x(3+(day_ind-1)*3),mean(er_temp_t3(:),1),std(er_temp_t3(:),1)/sqrt(length(er_temp_t3(:))),'k','LineWidth',1);
                end
            ...
            if day_ind == config.day_num + 1 % N
                bar(x(1+(day_ind-1)*3),mean(er_N_t1(:),1),'FaceColor',[1,0,0],'FaceAlpha',0.8,'EdgeColor','none');
                bar(x(2+(day_ind-1)*3),mean(er_N_t2(:),1),'FaceColor',[1,0,0],'FaceAlpha',0.6,'EdgeColor','none');
                bar(x(3+(day_ind-1)*3),mean(er_N_t3(:),1),'FaceColor',[1,0,0],'FaceAlpha',0.4,'EdgeColor','none');
                errorbar(x(1+(day_ind-1)*3),mean(er_N_t1(:),1),std(er_N_t1(:),1)/sqrt(length(er_N_t1(:))),'k','LineWidth',1); 
                errorbar(x(2+(day_ind-1)*3),mean(er_N_t2(:),1),std(er_N_t2(:),1)/sqrt(length(er_N_t2(:))),'k','LineWidth',1);
                errorbar(x(3+(day_ind-1)*3),mean(er_N_t3(:),1),std(er_N_t3(:),1)/sqrt(length(er_N_t3(:))),'k','LineWidth',1);
            else
                if day_ind == config.day_num + 2 % I
                    bar(x(1+(day_ind-1)*3),mean(er_I_t1(:),1),'FaceColor',[0,1,1],'FaceAlpha',0.8,'EdgeColor','none');
                    bar(x(2+(day_ind-1)*3),mean(er_I_t2(:),1),'FaceColor',[0,1,1],'FaceAlpha',0.6,'EdgeColor','none');
                    bar(x(3+(day_ind-1)*3),mean(er_I_t3(:),1),'FaceColor',[0,1,1],'FaceAlpha',0.4,'EdgeColor','none');
                    errorbar(x(1+(day_ind-1)*3),mean(er_I_t1(:),1),std(er_I_t1(:),1)/sqrt(length(er_I_t1(:))),'k','LineWidth',1); 
                    errorbar(x(2+(day_ind-1)*3),mean(er_I_t2(:),1),std(er_I_t2(:),1)/sqrt(length(er_I_t2(:))),'k','LineWidth',1);
                    errorbar(x(3+(day_ind-1)*3),mean(er_I_t3(:),1),std(er_I_t3(:),1)/sqrt(length(er_I_t3(:))),'k','LineWidth',1);                      
                else
                    if day_ind == config.day_num + 3 % O
                        bar(x(1+(day_ind-1)*3),mean(er_O_t1(:),1),'FaceColor',[0,0,1],'FaceAlpha',0.8,'EdgeColor','none');
                        bar(x(2+(day_ind-1)*3),mean(er_O_t2(:),1),'FaceColor',[0,0,1],'FaceAlpha',0.6,'EdgeColor','none');
                        bar(x(3+(day_ind-1)*3),mean(er_O_t3(:),1),'FaceColor',[0,0,1],'FaceAlpha',0.4,'EdgeColor','none');
                        errorbar(x(1+(day_ind-1)*3),mean(er_O_t1(:),1),std(er_O_t1(:),1)/sqrt(length(er_O_t1(:))),'k','LineWidth',1); 
                        errorbar(x(2+(day_ind-1)*3),mean(er_O_t2(:),1),std(er_O_t2(:),1)/sqrt(length(er_O_t2(:))),'k','LineWidth',1);
                        errorbar(x(3+(day_ind-1)*3),mean(er_O_t3(:),1),std(er_O_t3(:),1)/sqrt(length(er_O_t3(:))),'k','LineWidth',1); 
                    else % All
